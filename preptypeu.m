...
r.summary.full.preveldata = (r.data.pre(4,ind));
...
[s y] = myregress(r.summary.a.mot,log(r.summary.a.vel));
...
[s y] = myregress(r.summary.b.mot,log(r.summary.b.vel));
...
[s y] = myregress(r.summary.c.mot,log(r.summary.c.vel));

[r.stats.c.beta res jac] = nlinfit(r.summary.c.mot,r.summary.c.vel,'exponential',[y s]);
[r.stats.c.ci] = nlparci(r.stats.c.beta,res,jac);
...
%[r.stats.slope r.stats.yint jnk r.stats.pslope r.stats.pyint] = myregress(r.summary.pos',r.summary.vel');
%[r.stats.norm.slope r.stats.norm.yint jnk r.stats.norm.pslope r.stats.norm.pyint] = myregress(r.summary.norm.full.posdata',r.summary.norm.full.veldata');
